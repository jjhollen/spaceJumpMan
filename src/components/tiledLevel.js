...
//        components = "2D, " + drawType + ", " + sName + ", MapTile, Box2D, platform, Collision"; // added Box2D for physics usage, added platform for gravity
        components = "2D, " + drawType + ", " + sName + ", MapTile, platform, Collision"; // added Box2D for physics usage, added platform for gravity
        if (tsProperties) {
    ...
    tiledLevel: function(levelURL, drawType) {
      ...
      $.ajax({
        ...
        success: function(level) {
          ...
          drawType = drawType != null ? drawType : "DOM";
          tsImages = (function() {
